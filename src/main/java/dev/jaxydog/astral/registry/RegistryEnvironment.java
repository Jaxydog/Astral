...
import dev.jaxydog.astral.registry.Registered.Generated;
import dev.jaxydog.astral.registry.Registered.Server;
...
public enum RegistryEnvironment {
     ...
     *
     * @throws IllegalArgumentException If the provided value is not a valid instance of this environment's associated
     * interface.
     */
