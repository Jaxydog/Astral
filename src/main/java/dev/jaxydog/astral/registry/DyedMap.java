...
import dev.jaxydog.astral.utility.Dyed;
 ...
 * @author Jaxydog
 */
public class DyedMap<V extends Dyed & Registered> extends RegisteredMap<DyeColor, V> {
     ...
     */
    public DyedMap(@NotNull String basePath, BiFunction<@NotNull String, @NotNull DyeColor, V> computeCallback) {
