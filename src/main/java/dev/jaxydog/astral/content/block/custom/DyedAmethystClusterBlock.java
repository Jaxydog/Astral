...
/** Implements a dye-able amethyst cluster block */
public class DyedAmethystClusterBlock extends DyedAmethystBlock implements Registerable.Client, Waterloggable {
	...
	protected final VoxelShape UP_SHAPE = Block.createCuboidShape(3.0D, 0.0F, 3.0D, 13.0D, 7.0D, 13.0D);
	...
	protected final VoxelShape SOUTH_SHAPE = Block.createCuboidShape(3.0D, 3.0D, 0.0F, 13.0D, 13.0D, 7.0D);
	protected final VoxelShape EAST_SHAPE = Block.createCuboidShape(0.0F, 3.0D, 3.0D, 7.0D, 13.0D, 13.0D);
