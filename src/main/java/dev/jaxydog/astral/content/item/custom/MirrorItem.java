...
public class MirrorItem extends AstralItem implements Client {
     ...
     */
    public static final Identifier BROKEN_MODEL_ID = Astral.getModId("broken");
    ...
    /**
     * Returns the data used in the mirror's item model that determines which texture to use.
     * <p>
