...
public interface Sprayed extends Client, Custom {
    ...
    default void invokeSpray(ItemStack stack, World world, @Nullable LivingEntity entity, Entity target, int charges) {
        ...
        targetPowers.stream().filter(p -> p.canBeSprayed(entity, stack));
     ...
     * @param charges The charges consumed.
     */
    default void invokeSpray(ItemStack stack, World world, @Nullable LivingEntity entity, BlockPos pos, int charges) {
    ...
    default void invokeSpray(ItemStack stack, World world, @Nullable LivingEntity entity, int charges) {
        if (!(stack.getItem() instanceof Sprayed) || !this.hasCharges(stack)) return;
    ...
    default void invokeFill(ItemStack stack, World world, BlockPos pos, @Nullable LivingEntity entity, int charges) {
        if (!(stack.getItem() instanceof Sprayed) || !this.canFill(stack)) return;
    ...
    /**
     * Returns the data used in the sprayable item's model that determines which texture to use.
     * <p>
