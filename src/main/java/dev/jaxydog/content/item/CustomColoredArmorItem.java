...
public abstract class CustomColoredArmorItem extends CustomArmorItem implements Registered.Client {

    public CustomColoredArmorItem(String rawId, ArmorMaterial material, Type type, Settings settings) {
