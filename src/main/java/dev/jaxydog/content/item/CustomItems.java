...
public final class CustomItems extends ContentContainer {
	...
	public static final CloudyItem CLOUDY_MANE = new CloudyItem(
		"cloudy_mane",
	...
	public static final PlaceholderItem PLACEHOLDER = new PlaceholderItem(
		"placeholder",
	...
	public static final CustomBlockItem RANDOMIZER_BLOCK = new CustomBlockItem(
		"randomizer", CustomBlocks.RANDOMIZER,
		new Settings().rarity(Rarity.UNCOMMON));
	...
	private static final class ArmorMaterials {
		...
		public static final CustomArmorMaterial CLOUDY = CustomArmorMaterial
			.builder("cloud")
