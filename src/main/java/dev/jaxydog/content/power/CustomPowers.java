...
public final class CustomPowers extends ContentContainer {
	...
	public static final CustomPowerFactory<ScalePower> SCALE =
			new CustomPowerFactory<ScalePower>("scale",
					...
					data -> (type, entity) -> new ScalePower(type, entity, data.getFloat("width"),
							data.getFloat("height"), data.getFloat("reach"),
							data.getFloat("motion"), data.getBoolean("reset_on_lost")))
									.allowCondition();
