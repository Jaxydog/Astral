...
public final class CustomData extends ContentContainer {
    ...
    public static final SerializableDataType<ScaleOperation> SCALE_OPERATION =
            SerializableDataType.enumValue(ScaleOperation.class, SerializationHelper
                    .buildEnumMap(ScaleOperation.class, ScaleOperation::getName));
}
